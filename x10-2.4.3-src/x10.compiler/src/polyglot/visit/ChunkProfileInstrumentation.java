...
public class ChunkProfileInstrumentation extends ContextVisitor {
	...
	public ChunkProfileInstrumentation(Job job, TypeSystem ts, NodeFactory xnf) {
		super(job, ts, xnf);
		this.ts = ts;
		this.xnf = xnf;
