...
public final class Configuration extends x10.config.Configuration {
     ...
     * @author induk
     */
    public boolean CHUNK_CUSTOM = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_CUSTOM_desc = "Custom chunk all the par-for-loop";
    
    public boolean CHUNK_ATOMIC = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_ATOMIC_desc = "Custom chunk all the par-for-loop in presence of atomic";
  
    
    public boolean CHUNK_CYCLIC = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_CYCLIC_desc = "Cyclic chunk all the par-for-loop";
    
    public boolean CHUNK_BLOCK = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_BLOCK_desc = "BLOCK chunk all the par-for-loop";
    
    public boolean CHUNK_DYNAMIC = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_DYNAMIC_desc = "Chunk the finish-for loop dynamically";
    
    public boolean CHUNK_GUIDED = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_GUIDED_desc = "Chunk the finish-for loop similar to guided scheduling";
    
    public boolean CHUNK_HISTORY = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_HISTORY_desc = "Chunk the finish-for loop similar to history scheduling";
    
    public boolean CHUNK_HISTORY_PROFILE = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_HISTORY_PROFILE_desc = "Profile instrumentation the finish-for loop similar to history scheduling";
    
    
    public boolean CHUNK_PROFILE = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_PROFILE_desc = "Profile the required basic blocks for custom chunking";
   
    public boolean CHUNK_ATOMIC_PROFILE = false;		// Setting "true" only for simulation -- By default should be false
    private static final String CHUNK_ATOMIC_PROFILE_desc = "Profile the required basic blocks for custom chunking";
    
    public int FINISH_ID= 0;		// Setting "true" only for simulation -- By default should be false
    private static final String FINISH_ID_desc = "No Chunking for this finish";
