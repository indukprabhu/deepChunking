...
template<class TPMGL(T)> class DistArray__LocalState : public ::x10::lang::X10Class
  {
    ...
    virtual ::x10::regionarray::DistArray__LocalState<TPMGL(T)>* x10__regionarray__DistArray__LocalState____this__x10__regionarray__DistArray__LocalState(
      );
...
template<class TPMGL(T)> void x10::regionarray::DistArray__LocalState<TPMGL(T)>::_constructor(
    ...
    //#line 67 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/regionarray/DistArray.x10"
    ::x10::regionarray::DistArray__LocalState<TPMGL(T)>* this__112236 =
      this;
