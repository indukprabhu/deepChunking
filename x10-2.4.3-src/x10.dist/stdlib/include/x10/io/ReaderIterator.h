...
template<class TPMGL(T)> void x10::io::ReaderIterator<TPMGL(T)>::_constructor(
    ...
    ::x10::io::ReaderIterator<TPMGL(T)>* this__87810 = this;
    ::x10aux::nullCheck(this__87810)->FMGL(next) = ::x10aux::zeroValue< TPMGL(T) >();
    ...
    if ((::x10aux::struct_equals(this->FMGL(next), ::x10aux::zeroValue< TPMGL(T) >())))
    {
        ...
        try {
            ...
            this->FMGL(next) = (__extension__ ({
                ::x10::io::Reader* this__87809 = this->FMGL(r);
                
                //#line 129 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/io/Reader.x10"
                ::x10::io::Marshal<TPMGL(T)>* m__87808 = this->FMGL(m);
                ::x10::io::Marshal<TPMGL(T)>::read(::x10aux::nullCheck(m__87808), 
                  this__87809);
            }))
            ;
        }
        catch (::x10::lang::CheckedThrowable* __exc600) {
            if (::x10aux::instanceof< ::x10::io::IOException*>(__exc600)) {
                ::x10::io::IOException* id__68 = static_cast< ::x10::io::IOException*>(__exc600);
                {
