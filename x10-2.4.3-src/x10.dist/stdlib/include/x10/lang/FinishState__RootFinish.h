...
class FinishState__RootFinish : public ::x10::lang::FinishState__RootFinishSkeleton
  {
    ...
    static ::x10::lang::FinishState__RootFinish* _make();
    
    void _constructor(::x10::util::concurrent::SimpleLatch* latch);
    
    static ::x10::lang::FinishState__RootFinish* _make(::x10::util::concurrent::SimpleLatch* latch);
    
    virtual void notifySubActivitySpawn(::x10::lang::Place place);
    virtual void notifyActivityTermination();
    virtual void process(::x10::lang::Exception* t);
    ...
    virtual ::x10::lang::FinishState__RootFinish* x10__lang__FinishState__RootFinish____this__x10__lang__FinishState__RootFinish(
      );
    virtual void __fieldInitializers_x10_lang_FinishState_RootFinish(
      );
