...
class FinishState__FinishSkeleton : public ::x10::lang::FinishState   {
    ...
    ::x10::lang::GlobalRef< ::x10::lang::FinishState* > FMGL(ref);
    
    ::x10::lang::FinishState* FMGL(me);
    
    void _constructor(::x10::lang::FinishState__RootFinishSkeleton* root);
    ...
    virtual ::x10::lang::Any* evalAt(::x10::lang::Place place, ::x10::lang::Fun_0_0< ::x10::lang::Any*>* body,
                                     ::x10::lang::Runtime__Profile* prof);
    virtual ::x10::lang::FinishState__FinishSkeleton* x10__lang__FinishState__FinishSkeleton____this__x10__lang__FinishState__FinishSkeleton(
      );
    virtual void __fieldInitializers_x10_lang_FinishState_FinishSkeleton(
      );
