...
class Clock : public ::x10::lang::X10Class   {
    ...
    static void FMGL(FIRST_PHASE__do_init)();
    static void FMGL(FIRST_PHASE__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(FIRST_PHASE__status);
    static ::x10::lang::CheckedThrowable* FMGL(FIRST_PHASE__exception);
    ...
    x10_int get();
    ::x10::util::Box<x10_int>* put(x10_int ph);
    x10_int remove();
...
inline x10_int x10::lang::Clock::FMGL(FIRST_PHASE__get)() {
    if (FMGL(FIRST_PHASE__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(FIRST_PHASE__init)();
    }
