...
template<class TPMGL(T)> void x10::lang::Reducible__MaxReducer<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> this__103446 = (*this);
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MaxReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__125532 = ::x10aux::makeStringLit("struct x10.lang.Reducible.MaxReducer:"); strLit__125532; })), (__extension__ ({ static ::x10::lang::String* strLit__125533 = ::x10aux::makeStringLit(" zeroVal="); strLit__125533; }))), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> this__103447 =
      (*this);
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> other__103448 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MaxReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__103447->FMGL(zeroVal),
                                    other__103448->FMGL(zeroVal)));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MaxReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> this__103449 =
      (*this);
    ::x10::lang::Reducible__MaxReducer<TPMGL(T)> other__103450 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MaxReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__103449->FMGL(zeroVal),
                                    other__103450->FMGL(zeroVal)));
