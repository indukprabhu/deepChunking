...
template<class TPMGL(T)> void x10::lang::Reducible__MinReducer<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> this__103441 = (*this);
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__MinReducer<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__125488 = ::x10aux::makeStringLit("struct x10.lang.Reducible.MinReducer:"); strLit__125488; })), (__extension__ ({ static ::x10::lang::String* strLit__125489 = ::x10aux::makeStringLit(" zeroVal="); strLit__125489; }))), (*this)->FMGL(zeroVal));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> this__103442 =
      (*this);
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> other__103443 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MinReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__103442->FMGL(zeroVal),
                                    other__103443->FMGL(zeroVal)));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__MinReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> this__103444 =
      (*this);
    ::x10::lang::Reducible__MinReducer<TPMGL(T)> other__103445 =
      ::x10aux::class_cast< ::x10::lang::Reducible__MinReducer<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__103444->FMGL(zeroVal),
                                    other__103445->FMGL(zeroVal)));
