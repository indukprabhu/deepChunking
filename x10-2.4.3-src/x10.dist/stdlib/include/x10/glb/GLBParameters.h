...
class GLBParameters   {
    ...
    static x10_int FMGL(SHOW_RESULT_FLAG);
    static void FMGL(SHOW_RESULT_FLAG__do_init)();
    static void FMGL(SHOW_RESULT_FLAG__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(SHOW_RESULT_FLAG__status);
    static ::x10::lang::CheckedThrowable* FMGL(SHOW_RESULT_FLAG__exception);
    static x10_int FMGL(SHOW_RESULT_FLAG__get)();
    
    static x10_int FMGL(SHOW_TIMING_FLAG);
    static void FMGL(SHOW_TIMING_FLAG__do_init)();
    static void FMGL(SHOW_TIMING_FLAG__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(SHOW_TIMING_FLAG__status);
    static ::x10::lang::CheckedThrowable* FMGL(SHOW_TIMING_FLAG__exception);
    static x10_int FMGL(SHOW_TIMING_FLAG__get)();
    
    static x10_int FMGL(SHOW_TASKFRAME_LOG_FLAG);
    static void FMGL(SHOW_TASKFRAME_LOG_FLAG__do_init)();
    static void FMGL(SHOW_TASKFRAME_LOG_FLAG__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(SHOW_TASKFRAME_LOG_FLAG__status);
    static ::x10::lang::CheckedThrowable* FMGL(SHOW_TASKFRAME_LOG_FLAG__exception);
    static x10_int FMGL(SHOW_TASKFRAME_LOG_FLAG__get)();
    
    static x10_int FMGL(SHOW_GLB_FLAG);
    static void FMGL(SHOW_GLB_FLAG__do_init)();
    static void FMGL(SHOW_GLB_FLAG__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(SHOW_GLB_FLAG__status);
    static ::x10::lang::CheckedThrowable* FMGL(SHOW_GLB_FLAG__exception);
    ...
    void _constructor(x10_int n, x10_int w, x10_int l, x10_int z,
        ...
        ::x10::glb::GLBParameters this__80490 = (*this);
...
inline x10_int x10::glb::GLBParameters::FMGL(SHOW_RESULT_FLAG__get)() {
    if (FMGL(SHOW_RESULT_FLAG__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(SHOW_RESULT_FLAG__init)();
    }
    return x10::glb::GLBParameters::FMGL(SHOW_RESULT_FLAG);
}

inline x10_int x10::glb::GLBParameters::FMGL(SHOW_TIMING_FLAG__get)() {
    if (FMGL(SHOW_TIMING_FLAG__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(SHOW_TIMING_FLAG__init)();
    }
    return x10::glb::GLBParameters::FMGL(SHOW_TIMING_FLAG);
}

inline x10_int x10::glb::GLBParameters::FMGL(SHOW_TASKFRAME_LOG_FLAG__get)() {
    if (FMGL(SHOW_TASKFRAME_LOG_FLAG__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(SHOW_TASKFRAME_LOG_FLAG__init)();
    }
    return x10::glb::GLBParameters::FMGL(SHOW_TASKFRAME_LOG_FLAG);
}

inline x10_int x10::glb::GLBParameters::FMGL(SHOW_GLB_FLAG__get)() {
    if (FMGL(SHOW_GLB_FLAG__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(SHOW_GLB_FLAG__init)();
    }
