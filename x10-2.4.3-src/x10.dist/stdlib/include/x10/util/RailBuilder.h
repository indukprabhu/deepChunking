...
template<class TPMGL(T)> void x10::util::RailBuilder<TPMGL(T)>::_constructor(
    ...
    ::x10::util::RailBuilder<TPMGL(T)>* this__121815 = this;
    
    //#line 18 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/RailBuilder.x10"
    this->FMGL(buf) = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__120435 =  (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        
        //#line 50 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/GrowableRail.x10"
        (alloc__120435)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          ((x10_long)0ll));
        alloc__120435;
    }))
    ;
...
template<class TPMGL(T)> void x10::util::RailBuilder<TPMGL(T)>::_constructor(
    ...
    //#line 14 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/RailBuilder.x10"
    ::x10::util::RailBuilder<TPMGL(T)>* this__121816 = this;
    
    //#line 22 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/RailBuilder.x10"
    this->FMGL(buf) = (__extension__ ({
        ::x10::util::GrowableRail<TPMGL(T)>* alloc__120436 =  (new (::x10aux::alloc_z< ::x10::util::GrowableRail<TPMGL(T)> >()) ::x10::util::GrowableRail<TPMGL(T)>());
        (alloc__120436)->::x10::util::GrowableRail<TPMGL(T)>::_constructor(
          size);
        alloc__120436;
    }))
    ;
...
template<class TPMGL(T)> x10_long x10::util::RailBuilder<TPMGL(T)>::length(
    ...
    ::x10::util::GrowableRail<TPMGL(T)>* this__121817 = this->FMGL(buf);
    return ::x10aux::nullCheck(this__121817)->FMGL(size);
