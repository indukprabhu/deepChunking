...
template<class TPMGL(Key), class TPMGL(Value)> class x10_util_HashMap__KeySet__closure__1 : public ::x10::lang::Closure {
    ...
    static typename ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>::template itable <x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) > > _itable;
    static ::x10aux::itable_entry _itables[2];
    
    virtual ::x10aux::itable_entry* _getITables() { return _itables; }
    
    // closure body
    TPMGL(Key) __apply(::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>* e__117634) {
        
        //#line 251 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashMap.x10"
        return ::x10aux::nullCheck(e__117634)->FMGL(key);
    ...
    static const ::x10aux::RuntimeType* getRTT() { return ::x10aux::getRTT< ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >(); }
    virtual const ::x10aux::RuntimeType *_type() const { return ::x10aux::getRTT< ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >(); }
    
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashMap.x10:251";
    }

};

template<class TPMGL(Key), class TPMGL(Value)> typename ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>::template itable <x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) > >x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) >::_itable(&::x10::lang::Reference::equals, &::x10::lang::Closure::hashCode, &x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) >::__apply, &x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) >::toString, &::x10::lang::Closure::typeName);
template<class TPMGL(Key), class TPMGL(Value)> ::x10aux::itable_entry x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) >::_itables[2] = {::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >, &x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value) >::_itable),::x10aux::itable_entry(NULL, NULL)};
...
template<class TPMGL(Key), class TPMGL(Value)> void x10::util::HashMap__KeySet<TPMGL(Key), TPMGL(Value)>::_constructor(
    ...
    ::x10::util::HashMap__KeySet<TPMGL(Key), TPMGL(Value)>* this__117633 =
      this;
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10::lang::Iterator<TPMGL(Key)>*
  x10::util::HashMap__KeySet<TPMGL(Key), TPMGL(Value)>::iterator(
    ...
    //#line 251 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashMap.x10"
    ::x10::util::MapIterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>* alloc__117636 =
       (new (::x10aux::alloc_z< ::x10::util::MapIterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >()) ::x10::util::MapIterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>());
    
    //#line 18 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/MapIterator.x10"
    ::x10::lang::Iterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*>* i__117635 =
    ...
    alloc__117636->FMGL(i) = i__117635;
    
    //#line 20 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/MapIterator.x10"
    alloc__117636->FMGL(f) = reinterpret_cast< ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)>*>((new (::x10aux::alloc< ::x10::lang::Fun_0_1< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*, TPMGL(Key)> >(sizeof(x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value)>)))x10_util_HashMap__KeySet__closure__1<TPMGL(Key),TPMGL(Value)>()));
    
    //#line 251 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashMap.x10"
    return reinterpret_cast< ::x10::lang::Iterator<TPMGL(Key)>*>(alloc__117636);
