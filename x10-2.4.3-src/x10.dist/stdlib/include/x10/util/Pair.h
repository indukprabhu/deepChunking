...
template<class TPMGL(T), class TPMGL(U)> void x10::util::Pair<TPMGL(T), TPMGL(U)>::_constructor(
    ...
    ::x10::util::Pair<TPMGL(T), TPMGL(U)> this__121806 = (*this);
...
template<class TPMGL(T), class TPMGL(U)> ::x10::lang::String*
  x10::util::Pair<TPMGL(T), TPMGL(U)>::toString() {
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__129936 = ::x10aux::makeStringLit("("); strLit__129936; })), (*this)->FMGL(first)), (__extension__ ({ static ::x10::lang::String* strLit__129937 = ::x10aux::makeStringLit(", "); strLit__129937; }))), (*this)->FMGL(second)), (__extension__ ({ static ::x10::lang::String* strLit__129938 = ::x10aux::makeStringLit(")"); strLit__129938; })));
