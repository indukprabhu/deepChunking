...
template<class TPMGL(U)> void x10::util::WorkerLocalHandle__State<TPMGL(U)>::_constructor(
    ...
    ::x10::util::WorkerLocalHandle__State<TPMGL(U)>* this__123081 =
      this;
    ::x10aux::nullCheck(this__123081)->FMGL(init) = (::x10aux::class_cast_unchecked< ::x10::lang::Fun_0_0<TPMGL(U)>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    
    //#line 23 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/WorkerLocalHandle.x10"
    this->FMGL(store) = ::x10::lang::Rail< TPMGL(U) >::_make(((x10_long)(::x10::lang::Runtime::FMGL(MAX_THREADS__get)())));
