...
class Option   {
    ...
    ::x10::util::Option asFlag() {
                                      ...
                                      ((x10_int)0))) && !((*this)->FMGL(arbFollow))))
        {
            ...
            ::x10::util::Option alloc__121801 =  ::x10::util::Option::_alloc();
            (alloc__121801)->::x10::util::Option::_constructor(
              (*this)->FMGL(shortForm), (*this)->FMGL(longForm),
              (*this)->FMGL(description), ((x10_int)0), false,
              false, (*this)->FMGL(onTheFly));
            return alloc__121801;
    ...
    ::x10::util::Option asSimpleParm() {
                                      ...
                                      ((x10_int)1))) && !((*this)->FMGL(arbFollow))))
        {
            ...
            ::x10::util::Option alloc__121802 =  ::x10::util::Option::_alloc();
            (alloc__121802)->::x10::util::Option::_constructor(
              (*this)->FMGL(shortForm), (*this)->FMGL(longForm),
              (*this)->FMGL(description), ((x10_int)1), false,
              (*this)->FMGL(required), (*this)->FMGL(onTheFly));
            return alloc__121802;
