...
template<class TPMGL(T), class TPMGL(U), class TPMGL(V)> void x10::util::Triple<TPMGL(T), TPMGL(U), TPMGL(V)>::_constructor(
    ...
    ::x10::util::Triple<TPMGL(T), TPMGL(U), TPMGL(V)> this__122992 =
      (*this);
...
template<class TPMGL(T), class TPMGL(U), class TPMGL(V)> ::x10::lang::String*
  x10::util::Triple<TPMGL(T), TPMGL(U), TPMGL(V)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__130699 = ::x10aux::makeStringLit("("); strLit__130699; })), (*this)->FMGL(first)), (__extension__ ({ static ::x10::lang::String* strLit__130700 = ::x10aux::makeStringLit(", "); strLit__130700; }))), (*this)->FMGL(second)), (__extension__ ({ static ::x10::lang::String* strLit__130701 = ::x10aux::makeStringLit(", "); strLit__130701; }))), (*this)->FMGL(third)), (__extension__ ({ static ::x10::lang::String* strLit__130702 = ::x10aux::makeStringLit(")"); strLit__130702; })));
