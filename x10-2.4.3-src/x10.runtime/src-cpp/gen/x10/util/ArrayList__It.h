...
template<class TPMGL(S)> void x10::util::ArrayList__It<TPMGL(S)>::_constructor(
    ...
    //#line 152 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/ArrayList.x10"
    ::x10::util::ArrayList__It<TPMGL(S)>* this__117189 = this;
    ::x10aux::nullCheck(this__117189)->FMGL(i) = ((x10_long)0ll);
...
template<class TPMGL(S)> TPMGL(S) x10::util::ArrayList__It<TPMGL(S)>::next(
    ...
    ::x10::util::GrowableRail<TPMGL(S)>* this__117190 = ::x10aux::nullCheck(this->FMGL(al))->FMGL(a);
    
    //#line 115 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/GrowableRail.x10"
    x10_long idx__117191 = this->FMGL(i) = ((this->FMGL(i)) + (((x10_long)1ll)));
    TPMGL(S) ret__117192;
    
    //#line 117 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/GrowableRail.x10"
    ret__117192 = ::x10aux::nullCheck(::x10aux::nullCheck(this__117190)->FMGL(data))->x10::lang::template Rail< TPMGL(S) >::__apply(
                    idx__117191);
...
template<class TPMGL(S)> TPMGL(S) x10::util::ArrayList__It<TPMGL(S)>::previous(
    ...
    ::x10::util::GrowableRail<TPMGL(S)>* this__117193 = ::x10aux::nullCheck(this->FMGL(al))->FMGL(a);
    
    //#line 115 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/GrowableRail.x10"
    x10_long idx__117194 = this->FMGL(i) = ((this->FMGL(i)) - (((x10_long)1ll)));
    TPMGL(S) ret__117195;
    
    //#line 117 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/GrowableRail.x10"
    ret__117195 = ::x10aux::nullCheck(::x10aux::nullCheck(this__117193)->FMGL(data))->x10::lang::template Rail< TPMGL(S) >::__apply(
                    idx__117194);
