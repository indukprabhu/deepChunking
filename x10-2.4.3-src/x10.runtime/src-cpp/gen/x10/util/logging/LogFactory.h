...
#ifndef X10_UTIL_LOGGING_LOGFACTORY_H_getInstance_2769
#define X10_UTIL_LOGGING_LOGFACTORY_H_getInstance_2769
template<class TPMGL(T)> ::x10::util::logging::Log* x10::util::logging::LogFactory::getInstance(
  ::x10::util::logging::LogFactory* factory) {
    
    //#line 58 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/LogFactory.x10"
    return ::x10aux::nullCheck(factory)->getInstance(::x10aux::makeStringLit(x10aux::getRTT< TPMGL(T)>()->name()));
    
}
#endif // X10_UTIL_LOGGING_LOGFACTORY_H_getInstance_2769
#ifndef X10_UTIL_LOGGING_LOGFACTORY_H_getLog_2771
#define X10_UTIL_LOGGING_LOGFACTORY_H_getLog_2771
template<class TPMGL(T)> ::x10::util::logging::Log* x10::util::logging::LogFactory::getLog(
  ) {
    
    //#line 70 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/LogFactory.x10"
    return ::x10::util::logging::LogFactory::template getInstance< TPMGL(T) >(
             ::x10::util::logging::LogFactory::getFactory());
    
}
#endif // X10_UTIL_LOGGING_LOGFACTORY_H_getLog_2771
