...
class ConsoleLogFactory : public ::x10::util::logging::LogFactory   {
    ...
    using ::x10::util::logging::LogFactory::getInstance;
...
#ifndef X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2713
#define X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2713
template<class TPMGL(K)> ::x10::lang::Rail< TPMGL(K) >* x10::util::logging::ConsoleLogFactory::toRail(
  ::x10::util::Container<TPMGL(K)>* c) {
    
    //#line 58 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/ConsoleLogFactory.x10"
    ::x10::lang::Rail< TPMGL(K) >* arr = ::x10::lang::Rail< TPMGL(K) >::_makeUnsafe(::x10::util::Container<TPMGL(K)>::size(::x10aux::nullCheck(c)), false);
    
    //#line 59 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/ConsoleLogFactory.x10"
    x10_long i = ((x10_long)0ll);
    
    //#line 60 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/ConsoleLogFactory.x10"
    {
        ::x10::lang::Iterator<TPMGL(K)>* k__117673;
        for (k__117673 = ::x10::util::Container<TPMGL(K)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(K)>::hasNext(::x10aux::nullCheck(k__117673));
             ) {
            TPMGL(K) k = ::x10::lang::Iterator<TPMGL(K)>::next(::x10aux::nullCheck(k__117673));
            
            //#line 61 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/ConsoleLogFactory.x10"
            arr->x10::lang::template Rail< TPMGL(K) >::__set(
              (__extension__ ({
                  x10_long pre__117663 = i;
                  i = ((i) + (((x10_long)1ll)));
                  pre__117663;
              }))
              , k);
    ...
    //#line 63 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/logging/ConsoleLogFactory.x10"
    return arr;
    
}
#endif // X10_UTIL_LOGGING_CONSOLELOGFACTORY_H_toRail_2713
