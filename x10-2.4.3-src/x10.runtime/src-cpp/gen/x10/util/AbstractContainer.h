...
template<class TPMGL(T)> x10_boolean x10::util::AbstractContainer<TPMGL(T)>::containsAll(
  ::x10::util::Container<TPMGL(T)>* c) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__116972;
        for (x__116972 = ::x10::util::Container<TPMGL(T)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__116972));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__116972));
...
template<class TPMGL(T)> void x10::util::AbstractContainer<TPMGL(T)>::_constructor(
    ...
    ::x10::util::AbstractContainer<TPMGL(T)>* this__116985 =
      this;
