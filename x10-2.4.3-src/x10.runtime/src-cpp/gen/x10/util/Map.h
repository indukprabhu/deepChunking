...
template<class TPMGL(K), class TPMGL(V)> class Map   {
    ...
    template <class Iface> struct itable {
        itable(void (Iface::*clear) (), x10_boolean (Iface::*containsKey) (TPMGL(K)), ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(K), TPMGL(V)>*>* (Iface::*entries) (), x10_boolean (Iface::*equals) (::x10::lang::Any*), ::x10::util::Box<TPMGL(V)>* (Iface::*get) (TPMGL(K)), TPMGL(V) (Iface::*getOrElse) (TPMGL(K), TPMGL(V)), TPMGL(V) (Iface::*getOrThrow) (TPMGL(K)), x10_int (Iface::*hashCode) (), ::x10::util::Set<TPMGL(K)>* (Iface::*keySet) (), ::x10::util::Box<TPMGL(V)>* (Iface::*put) (TPMGL(K), TPMGL(V)), ::x10::util::Box<TPMGL(V)>* (Iface::*remove) (TPMGL(K)), x10_long (Iface::*size) (), ::x10::lang::String* (Iface::*toString) (), ::x10::lang::String* (Iface::*typeName) ()) : clear(clear), containsKey(containsKey), entries(entries), equals(equals), get(get), getOrElse(getOrElse), getOrThrow(getOrThrow), hashCode(hashCode), keySet(keySet), put(put), remove(remove), size(size), toString(toString), typeName(typeName) {}
        void (Iface::*clear) ();
        x10_boolean (Iface::*containsKey) (TPMGL(K));
        ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(K), TPMGL(V)>*>* (Iface::*entries) ();
        x10_boolean (Iface::*equals) (::x10::lang::Any*);
        ::x10::util::Box<TPMGL(V)>* (Iface::*get) (TPMGL(K));
        TPMGL(V) (Iface::*getOrElse) (TPMGL(K), TPMGL(V));
        TPMGL(V) (Iface::*getOrThrow) (TPMGL(K));
        x10_int (Iface::*hashCode) ();
        ::x10::util::Set<TPMGL(K)>* (Iface::*keySet) ();
        ::x10::util::Box<TPMGL(V)>* (Iface::*put) (TPMGL(K), TPMGL(V));
        ::x10::util::Box<TPMGL(V)>* (Iface::*remove) (TPMGL(K));
        x10_long (Iface::*size) ();
    ...
    template <class R> static ::x10::util::Box<TPMGL(V)>* get(R* _recv, TPMGL(K) arg0) {
        ::x10::lang::Reference* _refRecv = reinterpret_cast< ::x10::lang::Reference*>(_recv);
    ...
    template <class R> static ::x10::util::Box<TPMGL(V)>* put(R* _recv, TPMGL(K) arg0, TPMGL(V) arg1) {
        ::x10::lang::Reference* _refRecv = reinterpret_cast< ::x10::lang::Reference*>(_recv);
    ...
    template <class R> static ::x10::util::Box<TPMGL(V)>* remove(R* _recv, TPMGL(K) arg0) {
        ::x10::lang::Reference* _refRecv = reinterpret_cast< ::x10::lang::Reference*>(_recv);
