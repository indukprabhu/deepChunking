...
template<class TPMGL(T)> class x10_util_AbstractCollection__closure__1 : public ::x10::lang::Closure {
    ...
    // closure body
    x10_boolean __apply(TPMGL(T) id__159) {
        return true;
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/AbstractCollection.x10:19";
    }
...
template<class TPMGL(T)> class x10_util_AbstractCollection__closure__2 : public ::x10::lang::Closure {
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/AbstractCollection.x10:20";
    }
...
template<class TPMGL(T)> class x10_util_AbstractCollection__closure__3 : public ::x10::lang::Closure {
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/AbstractCollection.x10:21";
    }
...
template<class TPMGL(T)> class x10_util_AbstractCollection__closure__4 : public ::x10::lang::Closure {
    ...
    // closure body
    x10_boolean __apply(TPMGL(T) id__162) {
        return true;
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/AbstractCollection.x10:41";
    }
...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::addAllWhere(
  ::x10::util::Container<TPMGL(T)>* c, ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__79337;
        for (x__79337 = ::x10::util::Container<TPMGL(T)>::iterator(::x10aux::nullCheck(c));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__79337));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__79337));
...
template<class TPMGL(T)> x10_boolean x10::util::AbstractCollection<TPMGL(T)>::removeAllWhere(
  ::x10::lang::Fun_0_1<TPMGL(T), x10_boolean>* p) {
    ...
    {
        ::x10::lang::Iterator<TPMGL(T)>* x__79339;
        for (x__79339 = ::x10::util::Collection<TPMGL(T)>::iterator(::x10aux::nullCheck(reinterpret_cast< ::x10::util::Collection<TPMGL(T)>*>(this->clone())));
             ::x10::lang::Iterator<TPMGL(T)>::hasNext(::x10aux::nullCheck(x__79339));
             ) {
            TPMGL(T) x = ::x10::lang::Iterator<TPMGL(T)>::next(::x10aux::nullCheck(x__79339));
...
template<class TPMGL(T)> void x10::util::AbstractCollection<TPMGL(T)>::_constructor(
    ...
    ::x10::util::AbstractContainer<TPMGL(T)>* this__116981 =
      this;
    ::x10::util::AbstractCollection<TPMGL(T)>* this__116980 =
      this;
