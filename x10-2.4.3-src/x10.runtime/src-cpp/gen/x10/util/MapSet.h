...
template<class TPMGL(T)> void x10::util::MapSet<TPMGL(T)>::_constructor(::x10::util::Map<TPMGL(T), x10_boolean>* map) {
    ...
    ::x10::util::MapSet<TPMGL(T)>* this__118012 = this;
...
template<class TPMGL(T)> x10_boolean x10::util::MapSet<TPMGL(T)>::add(
  TPMGL(T) v) {
    return (::x10aux::struct_equals(::x10::util::Map<TPMGL(T), x10_boolean>::put(::x10aux::nullCheck(this->FMGL(map)), 
                                      v, true), reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
...
template<class TPMGL(T)> x10_boolean x10::util::MapSet<TPMGL(T)>::remove(
  TPMGL(T) v) {
    return (!::x10aux::struct_equals(::x10::util::Map<TPMGL(T), x10_boolean>::remove(::x10aux::nullCheck(this->FMGL(map)), 
                                       v), reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
