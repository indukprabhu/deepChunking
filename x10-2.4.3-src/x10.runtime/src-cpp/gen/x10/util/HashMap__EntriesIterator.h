...
template<class TPMGL(Key), class TPMGL(Value)> class HashMap__EntriesIterator : public ::x10::lang::X10Class
  {
    ...
    static typename ::x10::lang::Iterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*>::template itable< ::x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)> > _itable_0;
...
template<class TPMGL(Key), class TPMGL(Value)> void x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::_initRTT() {
    ...
    const ::x10aux::RuntimeType* parents[1] = { ::x10aux::getRTT< ::x10::lang::Iterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*> >()};
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10aux::itable_entry x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::_itables[3] = {::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::Iterator< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*> >, &_itable_0), ::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::Any>, &_itable_1), ::x10aux::itable_entry(NULL, (void*)"::x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>")};
...
template<class TPMGL(Key), class TPMGL(Value)> void x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::_constructor(
    ...
    ::x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>* this__117632 =
      this;
    ::x10aux::nullCheck(this__117632)->FMGL(i) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__117632)->FMGL(originalModCount) =
      ((x10_long)0ll);
...
template<class TPMGL(Key), class TPMGL(Value)> ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>*
  x10::util::HashMap__EntriesIterator<TPMGL(Key), TPMGL(Value)>::next(
    ...
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::Exception::_make(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__128827 = ::x10aux::makeStringLit("Your code has a concurrency bug! You updated the hashmap "); strLit__128827; })), ((::x10aux::nullCheck(this->FMGL(map))->FMGL(modCount)) - (this->FMGL(originalModCount)))), (__extension__ ({ static ::x10::lang::String* strLit__128828 = ::x10aux::makeStringLit(" times since you created the iterator."); strLit__128828; }))))));
    }
    ...
    return ::x10aux::nullCheck(::x10aux::nullCheck(this->FMGL(map))->FMGL(table))->x10::lang::template Rail< ::x10::util::HashMap__HashEntry<TPMGL(Key), TPMGL(Value)>* >::__apply(
             j);
