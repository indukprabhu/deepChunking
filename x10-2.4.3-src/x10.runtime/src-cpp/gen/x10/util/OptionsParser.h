...
class OptionsParser : public ::x10::lang::X10Class   {
    ...
    static x10_int FMGL(IGNORE);
    static void FMGL(IGNORE__do_init)();
    static void FMGL(IGNORE__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(IGNORE__status);
    static ::x10::lang::CheckedThrowable* FMGL(IGNORE__exception);
    static x10_int FMGL(IGNORE__get)();
    
    static x10_int FMGL(START_TAIL);
    static void FMGL(START_TAIL__do_init)();
    static void FMGL(START_TAIL__init)();
    static volatile ::x10aux::StaticInitController::status FMGL(START_TAIL__status);
    static ::x10::lang::CheckedThrowable* FMGL(START_TAIL__exception);
...
inline x10_int x10::util::OptionsParser::FMGL(IGNORE__get)() {
    if (FMGL(IGNORE__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(IGNORE__init)();
    }
...
inline x10_int x10::util::OptionsParser::FMGL(START_TAIL__get)() {
    if (FMGL(START_TAIL__status) != ::x10aux::StaticInitController::INITIALIZED) {
        FMGL(START_TAIL__init)();
    }
