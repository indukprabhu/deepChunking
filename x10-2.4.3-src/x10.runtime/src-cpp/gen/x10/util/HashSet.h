...
template<class TPMGL(T)> void x10::util::HashSet<TPMGL(T)>::_constructor(
                           x10_int sz) {
    (this)->::x10::util::MapSet<TPMGL(T)>::_constructor(reinterpret_cast< ::x10::util::Map<TPMGL(T), x10_boolean>*>((__extension__ ({
                                                            ::x10::util::HashMap<TPMGL(T), x10_boolean>* alloc__117646 =
                                                              
                                                            (new (::x10aux::alloc_z< ::x10::util::HashMap<TPMGL(T), x10_boolean> >()) ::x10::util::HashMap<TPMGL(T), x10_boolean>());
                                                            (alloc__117646)->::x10::util::HashMap<TPMGL(T), x10_boolean>::_constructor(
                                                              ((x10_long)(sz)));
                                                            alloc__117646;
                                                        }))
                                                        ));
    ...
    //#line 14 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashSet.x10"
    ::x10::util::HashSet<TPMGL(T)>* this__117660 = this;
...
template<class TPMGL(T)> void x10::util::HashSet<TPMGL(T)>::_constructor(
    ...
    //#line 14 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/HashSet.x10"
    ::x10::util::HashSet<TPMGL(T)>* this__117661 = this;
...
template<class TPMGL(T)> ::x10::util::Container<TPMGL(T)>*
  x10::util::HashSet<TPMGL(T)>::clone() {
    ...
    {
        ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>* e__117649;
        for (e__117649 = ::x10::util::Set< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::iterator(::x10aux::nullCheck(::x10::util::Map<TPMGL(T), x10_boolean>::entries(::x10aux::nullCheck(this->FMGL(map)))));
             ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::hasNext(::x10aux::nullCheck(e__117649));
             ) {
            ::x10::util::Map__Entry<TPMGL(T), x10_boolean>* e =
              ::x10::lang::Iterator< ::x10::util::Map__Entry<TPMGL(T), x10_boolean>*>::next(::x10aux::nullCheck(e__117649));
    ...
    ::x10::util::HashSet<TPMGL(T)>* alloc__117662 =  (new (::x10aux::alloc_z< ::x10::util::HashSet<TPMGL(T)> >()) ::x10::util::HashSet<TPMGL(T)>());
    (alloc__117662)->::x10::util::HashSet<TPMGL(T)>::_constructor(
      tmp);
    return reinterpret_cast< ::x10::util::Container<TPMGL(T)>*>(alloc__117662);
