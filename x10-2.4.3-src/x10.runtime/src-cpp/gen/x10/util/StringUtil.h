...
#ifndef X10_UTIL_STRINGUTIL_H_formatArray_2961
#define X10_UTIL_STRINGUTIL_H_formatArray_2961
template<class TPMGL(T)> ::x10::lang::String* x10::util::StringUtil::formatArray(
  ::x10::lang::Rail< TPMGL(T) >* a) {
    return ::x10::util::StringUtil::template formatArray< TPMGL(T) >(
             a, (__extension__ ({ static ::x10::lang::String* strLit__130478 = ::x10aux::makeStringLit(", "); strLit__130478; })),
             (__extension__ ({ static ::x10::lang::String* strLit__130479 = ::x10aux::makeStringLit("    "); strLit__130479; })),
             ((x10_int)80));
    
}
#endif // X10_UTIL_STRINGUTIL_H_formatArray_2961
#ifndef X10_UTIL_STRINGUTIL_H_formatArray_2962
#define X10_UTIL_STRINGUTIL_H_formatArray_2962
template<class TPMGL(T)> ::x10::lang::String* x10::util::StringUtil::formatArray(
  ...
  ::x10::lang::String* leftPad, x10_int maxLength) {
    ...
    if ((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(a)->FMGL(size)),
                                 ((x10_long)0ll)))) {
        return (__extension__ ({ static ::x10::lang::String* strLit__130480 = ::x10aux::makeStringLit(""); strLit__130480; }));
    ...
    x10_long i__121684max__122175 = (((x10_long)(::x10aux::nullCheck(a)->FMGL(size))) - (((x10_long)2ll)));
    {
        x10_long i__122176;
        for (i__122176 = ((x10_long)0ll); ((i__122176) <= (i__121684max__122175));
             i__122176 = ((i__122176) + (((x10_long)1ll))))
        {
            x10_long n__122177 = i__122176;
            ...
            if (((::x10aux::nullCheck(aLine)->length()) >= (((x10_long)(maxLength)))))
            {
                ...
                lines->add((__extension__ ({ static ::x10::lang::String* strLit__130487 = ::x10aux::makeStringLit("\n"); strLit__130487; })));
                
                //#line 121 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/StringUtil.x10"
                aLine = (__extension__ ({
                    ::x10::util::StringBuilder* alloc__122174 =
                       (new (::x10aux::alloc_z< ::x10::util::StringBuilder>()) ::x10::util::StringBuilder());
                    (alloc__122174)->::x10::util::StringBuilder::_constructor();
                    alloc__122174;
                }))
                ;
    ...
    if (((::x10aux::nullCheck(aLine)->length()) >= (((x10_long)(maxLength)))))
    {
        ...
        lines->add((__extension__ ({ static ::x10::lang::String* strLit__130491 = ::x10aux::makeStringLit("\n"); strLit__130491; })));
        
        //#line 128 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/util/StringUtil.x10"
        aLine = (__extension__ ({
            ::x10::util::StringBuilder* alloc__121682 =  (new (::x10aux::alloc_z< ::x10::util::StringBuilder>()) ::x10::util::StringBuilder());
            (alloc__121682)->::x10::util::StringBuilder::_constructor();
            alloc__121682;
        }))
        ;
    ...
    if (((::x10aux::nullCheck(aLine)->length()) >= (((x10_long)(maxLength)))))
    {
        ::x10aux::nullCheck(aLine)->add((__extension__ ({ static ::x10::lang::String* strLit__130496 = ::x10aux::makeStringLit("\n"); strLit__130496; })));
    }
...
#endif // X10_UTIL_STRINGUTIL_H_formatArray_2962
#ifndef X10_UTIL_STRINGUTIL_H_makeSet_2963
#define X10_UTIL_STRINGUTIL_H_makeSet_2963
...
#endif // X10_UTIL_STRINGUTIL_H_makeSet_2963
#ifndef X10_UTIL_STRINGUTIL_H_makeSet_2964
#define X10_UTIL_STRINGUTIL_H_makeSet_2964
template<class TPMGL(T)> ::x10::util::HashSet<TPMGL(T)>* x10::util::StringUtil::makeSet(
  ::x10::lang::Rail< TPMGL(T) >* a, x10_int hashTableSize) {
    ...
    ::x10::lang::Rail< TPMGL(T) >* rail__122178 = a;
    x10_long size__122179 = (x10_long)(::x10aux::nullCheck(rail__122178)->FMGL(size));
    {
        x10_long idx__122180;
        for (idx__122180 = ((x10_long)0ll); ((idx__122180) < (size__122179));
             idx__122180 = ((idx__122180) + (((x10_long)1ll))))
        {
            TPMGL(T) v__122181 = ::x10aux::nullCheck(rail__122178)->x10::lang::template Rail< TPMGL(T) >::__apply(
                                   idx__122180);
            set->add(v__122181);
        }
    }
...
#endif // X10_UTIL_STRINGUTIL_H_makeSet_2964
