...
class Runtime__RemoteControl : public ::x10::util::concurrent::SimpleLatch
  {
    ...
    static ::x10::io::Unserializable::itable< ::x10::lang::Runtime__RemoteControl > _itable_0;
    ...
    static ::x10::lang::Runtime__RemoteControl* _make();
    
    ::x10::lang::CheckedThrowable* FMGL(e);
    
    ::x10::lang::Activity__ClockPhases* FMGL(clockPhases);
    
    virtual ::x10::lang::Runtime__RemoteControl* x10__lang__Runtime__RemoteControl____this__x10__lang__Runtime__RemoteControl(
      );
    virtual void __fieldInitializers_x10_lang_Runtime_RemoteControl(
      );
    
    // Serialization
    virtual void _serialize_body(::x10aux::serialization_buffer& buf) {
        ::x10aux::throwNotSerializableException("Can't serialize x10.lang.Runtime$RemoteControl");
    }
