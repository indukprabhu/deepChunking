...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::Reducible__SumReducer<TPMGL(T)>::toString(
    ...
    return (__extension__ ({ static ::x10::lang::String* strLit__125445 = ::x10aux::makeStringLit("struct x10.lang.Reducible.SumReducer"); strLit__125445; }));
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__SumReducer<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__SumReducer<TPMGL(T)> this__103436 =
      (*this);
    ::x10::lang::Reducible__SumReducer<TPMGL(T)> other__103437 =
...
template<class TPMGL(T)> x10_boolean x10::lang::Reducible__SumReducer<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::Reducible__SumReducer<TPMGL(T)> this__103438 =
      (*this);
    ::x10::lang::Reducible__SumReducer<TPMGL(T)> other__103439 =
      ::x10aux::class_cast< ::x10::lang::Reducible__SumReducer<TPMGL(T)> >(other);
    return true;
...
template<class TPMGL(T)> void x10::lang::Reducible__SumReducer<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::Reducible__SumReducer<TPMGL(T)> this__103440 =
      (*this);
