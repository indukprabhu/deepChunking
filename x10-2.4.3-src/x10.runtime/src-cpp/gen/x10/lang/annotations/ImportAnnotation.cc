...
void x10::lang::annotations::ImportAnnotation::_initRTT() {
    ...
    rtt.initStageTwo("x10.lang.annotations.ImportAnnotation",::x10aux::RuntimeType::interface_kind, 2, parents, 0, NULL, NULL);
}

/* END of ImportAnnotation */
/*************************************************/
