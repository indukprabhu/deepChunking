...
template<class TPMGL(T)> void x10::lang::CUDAConstantRail<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::CUDAConstantRail<TPMGL(T)> this__93659 = (*this);
...
template<class TPMGL(T)> ::x10::lang::String* x10::lang::CUDAConstantRail<TPMGL(T)>::toString(
    ...
    return ::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__124207 = ::x10aux::makeStringLit("struct x10.lang.CUDAConstantRail:"); strLit__124207; })), (__extension__ ({ static ::x10::lang::String* strLit__124208 = ::x10aux::makeStringLit(" backing="); strLit__124208; }))), (*this)->FMGL(backing));
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::CUDAConstantRail<TPMGL(T)> this__93660 =
      (*this);
    ::x10::lang::CUDAConstantRail<TPMGL(T)> other__93661 =
      ::x10aux::class_cast< ::x10::lang::CUDAConstantRail<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__93660->FMGL(backing),
                                    other__93661->FMGL(backing)));
...
template<class TPMGL(T)> x10_boolean x10::lang::CUDAConstantRail<TPMGL(T)>::_struct_equals(
  ::x10::lang::Any* other) {
    ...
    ::x10::lang::CUDAConstantRail<TPMGL(T)> this__93662 =
      (*this);
    ::x10::lang::CUDAConstantRail<TPMGL(T)> other__93663 =
      ::x10aux::class_cast< ::x10::lang::CUDAConstantRail<TPMGL(T)> >(other);
    return (::x10aux::struct_equals(this__93662->FMGL(backing),
                                    other__93663->FMGL(backing)));
