...
template<class TPMGL(T)> ::x10aux::itable_entry x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::_itables[4] = {::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::Runtime__Mortal>, &_itable_0), ::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::Any>, &_itable_1), ::x10aux::itable_entry(&::x10aux::getRTT< ::x10::lang::FinishState__CollectingFinishState<TPMGL(T)> >, &_itable_2), ::x10aux::itable_entry(NULL, (void*)"::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>")};

//#line 771 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"

//#line 772 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
template<class TPMGL(T)> void x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::_constructor(
                           ::x10::lang::Reducible<TPMGL(T)>* reducer) {
    
    //#line 773 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    (this)->::x10::lang::FinishState__RootFinish::_constructor();
    
    //#line 772 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    
    //#line 770 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>* this__102443 =
      this;
    
    //#line 774 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    this->FMGL(sr) = (__extension__ ({
        ::x10::lang::FinishState__StatefulReducer<TPMGL(T)>* alloc__92663 =
           (new (::x10aux::alloc_z< ::x10::lang::FinishState__StatefulReducer<TPMGL(T)> >()) ::x10::lang::FinishState__StatefulReducer<TPMGL(T)>());
        (alloc__92663)->::x10::lang::FinishState__StatefulReducer<TPMGL(T)>::_constructor(
          reducer);
        alloc__92663;
    }))
    ;
...
template<class TPMGL(T)> ::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>* x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::_make(
                           ::x10::lang::Reducible<TPMGL(T)>* reducer)
{
    ::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>* this_ = new (::x10aux::alloc_z< ::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)> >()) ::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>();
...
//#line 776 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
template<class TPMGL(T)> void x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::accept(
  TPMGL(T) t, x10_int id) {
    
    //#line 777 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(sr))->accept(t, id);
}

//#line 779 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
template<class TPMGL(T)> void x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::notifyValue(
  ::x10::lang::Rail< x10_byte >* remoteMapBytes, TPMGL(T) v) {
    ...
    //#line 780 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ...
    //#line 781 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(latch))->lock();
    
    //#line 782 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(sr))->accept(v);
    
    //#line 783 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    this->process(remoteMap);
    
    //#line 784 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(latch))->unlock();
}

//#line 786 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
template<class TPMGL(T)> void x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::notifyValue(
  ::x10::util::Pair<x10_long, x10_int> remoteEntry, TPMGL(T) v) {
    
    //#line 787 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(latch))->lock();
    
    //#line 788 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(sr))->accept(v);
    
    //#line 789 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    this->process(remoteEntry);
    
    //#line 790 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(latch))->unlock();
}

//#line 792 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
template<class TPMGL(T)> TPMGL(T) x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::waitForFinishExpr(
  ) {
    
    //#line 793 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    this->waitForFinish();
    
    //#line 794 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(sr))->placeMerge();
    
    //#line 795 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    TPMGL(T) result = ::x10aux::nullCheck(this->FMGL(sr))->result();
    
    //#line 796 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    ::x10aux::nullCheck(this->FMGL(sr))->reset();
    
    //#line 797 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/FinishState.x10"
    return result;
...
template<class TPMGL(T)> const ::x10aux::serialization_id_t x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::_serialization_id = 
    ::x10aux::DeserializationDispatcher::addDeserializer(::x10::lang::FinishState__RootCollectingFinish<TPMGL(T)>::_deserializer);
