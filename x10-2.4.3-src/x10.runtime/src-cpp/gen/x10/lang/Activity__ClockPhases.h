...
class Activity__ClockPhases : public ::x10::util::HashMap< ::x10::lang::Clock*, x10_int>
  {
    public:
    RTT_H_DECLS_CLASS
    ...
    static ::x10::util::Map< ::x10::lang::Clock*, x10_int>::itable< ::x10::lang::Activity__ClockPhases > _itable_0;
    ...
    static ::x10::lang::Activity__ClockPhases* make(::x10::lang::Rail< ::x10::lang::Clock* >* clocks);
    ...
    static ::x10::lang::Activity__ClockPhases* _make();
    
    void _constructor(::x10::io::Deserializer* ds);
    
    static ::x10::lang::Activity__ClockPhases* _make(::x10::io::Deserializer* ds);
    
    virtual ::x10::lang::Activity__ClockPhases* x10__lang__Activity__ClockPhases____this__x10__lang__Activity__ClockPhases(
      );
    virtual void __fieldInitializers_x10_lang_Activity_ClockPhases(
      );
