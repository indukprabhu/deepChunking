...
template<class TPMGL(T)> class x10_lang_GlobalCell__closure__1 : public ::x10::lang::Closure {
    ...
    TPMGL(T) __apply() {
        try {
            ...
            if (true) {
                ::x10::lang::CheckedThrowable* __lowerer__var__0__ = static_cast< ::x10::lang::CheckedThrowable*>(__exc1144);
                {
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/GlobalCell.x10:35";
    }
...
template<class TPMGL(T)> class x10_lang_GlobalCell__closure__2 : public ::x10::lang::Closure {
        ...
        try {
            ...
            if (true) {
                ::x10::lang::CheckedThrowable* __lowerer__var__0__ =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc1146);
                {
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/GlobalCell.x10:43";
    }
...
template<class TPMGL(T)> class x10_lang_GlobalCell__closure__3 : public ::x10::lang::Closure {
    ...
    void __apply() {
        try {
            ...
            if (true) {
                ::x10::lang::CheckedThrowable* __lowerer__var__0__ =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc1149);
                {
                    x10_int __lowerer__var__1__ = ::x10aux::class_cast_unchecked<x10_int>(::x10::lang::Runtime::template wrapAtChecked< x10_int >(
                                                                                            __lowerer__var__0__));
    ...
    const char* toNativeString() {
        return "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/GlobalCell.x10:54-56";
    }
...
template<class TPMGL(T)> void x10::lang::GlobalCell<TPMGL(T)>::_constructor(
    ...
    ::x10::lang::GlobalCell<TPMGL(T)>* this__102669 = this;
    ...
    this->FMGL(root) = ::x10::lang::GlobalRef< ::x10::lang::Cell<TPMGL(T)>* >((__extension__ ({
        ::x10::lang::Cell<TPMGL(T)>* alloc__102660 =  (new (::x10aux::alloc_z< ::x10::lang::Cell<TPMGL(T)> >()) ::x10::lang::Cell<TPMGL(T)>());
        
        //#line 33 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/Cell.x10"
        TPMGL(T) x__102670 = v;
        alloc__102660->FMGL(value) = x__102670;
        alloc__102660;
    }))
    );
}
...
template<class TPMGL(T)> ::x10::lang::GlobalCell<TPMGL(T)>*
  x10::lang::GlobalCell<void>::make(TPMGL(T) x) {
    ...
    //#line 67 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/lang/GlobalCell.x10"
    ::x10::lang::GlobalCell<TPMGL(T)>* alloc__102671 =  (new (::x10aux::alloc_z< ::x10::lang::GlobalCell<TPMGL(T)> >()) ::x10::lang::GlobalCell<TPMGL(T)>());
    (alloc__102671)->::x10::lang::GlobalCell<TPMGL(T)>::_constructor(
      x);
    return alloc__102671;
