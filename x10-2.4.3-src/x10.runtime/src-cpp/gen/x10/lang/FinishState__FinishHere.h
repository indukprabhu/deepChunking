...
class FinishState__FinishHere : public ::x10::lang::FinishState__FinishSkeleton
  {
    ...
    static ::x10::lang::FinishState__FinishHere* _make();
    
    void _constructor(::x10::lang::GlobalRef< ::x10::lang::FinishState* > ref);
    
    static ::x10::lang::FinishState__FinishHere* _make(::x10::lang::GlobalRef< ::x10::lang::FinishState* > ref);
    
    void _constructor(::x10::io::Deserializer* ds);
    
    static ::x10::lang::FinishState__FinishHere* _make(::x10::io::Deserializer* ds);
    
    virtual ::x10::lang::FinishState__FinishHere* x10__lang__FinishState__FinishHere____this__x10__lang__FinishState__FinishHere(
      );
    virtual void __fieldInitializers_x10_lang_FinishState_FinishHere(
      );
