...
class FinishState__Finish : public ::x10::lang::FinishState__FinishSkeleton
  {
    ...
    static ::x10::lang::FinishState__Finish* _make(::x10::lang::FinishState__RootFinish* root);
    
    void _constructor(::x10::util::concurrent::SimpleLatch* latch);
    
    static ::x10::lang::FinishState__Finish* _make(::x10::util::concurrent::SimpleLatch* latch);
    
    void _constructor();
    
    static ::x10::lang::FinishState__Finish* _make();
    
    void _constructor(::x10::lang::GlobalRef< ::x10::lang::FinishState* > ref);
    
    static ::x10::lang::FinishState__Finish* _make(::x10::lang::GlobalRef< ::x10::lang::FinishState* > ref);
    
    void _constructor(::x10::io::Deserializer* ds);
    
    static ::x10::lang::FinishState__Finish* _make(::x10::io::Deserializer* ds);
    
    virtual ::x10::lang::FinishState__Finish* x10__lang__FinishState__Finish____this__x10__lang__FinishState__Finish(
      );
    virtual void __fieldInitializers_x10_lang_FinishState_Finish(
      );
