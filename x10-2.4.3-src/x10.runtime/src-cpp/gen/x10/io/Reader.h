...
#ifndef X10_IO_READER_H_read_624
#define X10_IO_READER_H_read_624
...
#endif // X10_IO_READER_H_read_624
#ifndef X10_IO_READER_H_read_625
#define X10_IO_READER_H_read_625
...
#endif // X10_IO_READER_H_read_625
#ifndef X10_IO_READER_H_read_626
#define X10_IO_READER_H_read_626
template<class TPMGL(T)> void x10::io::Reader::read(::x10::io::Marshal<TPMGL(T)>* m,
                                                    ::x10::lang::Rail< TPMGL(T) >* a,
                                                    x10_long off,
                                                    x10_long len) {
    ...
    //#line 144 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/io/Reader.x10"
    {
        ...
        for (i = off; ((i) < (((off) + (len)))); i = ((i) + (((x10_long)1ll))))
        {
            ...
            ::x10aux::nullCheck(a)->x10::lang::template Rail< TPMGL(T) >::__set(
              i, (__extension__ ({
                  ::x10::io::Reader* this__87816 = this;
                  
                  //#line 129 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/io/Reader.x10"
                  ::x10::io::Marshal<TPMGL(T)>* m__87815 =
                    m;
                  ::x10::io::Marshal<TPMGL(T)>::read(::x10aux::nullCheck(m__87815), 
                    this__87816);
              }))
              );
        }
...
#endif // X10_IO_READER_H_read_626
