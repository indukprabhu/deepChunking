...
//#line 38 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/NativeRep.x10"
...
void x10::compiler::NativeRep::_initRTT() {
    ...
    rtt.initStageTwo("x10.compiler.NativeRep",::x10aux::RuntimeType::interface_kind, 2, parents, 0, NULL, NULL);
}
