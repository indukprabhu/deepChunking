...
class FinishFrame : public ::x10::compiler::ws::Frame   {
    ...
    void _constructor(::x10::compiler::ws::Frame* up) {
        ...
        ::x10::compiler::ws::FinishFrame* this__77985 = this;
        ...
        this->FMGL(exceptions) = (::x10aux::class_cast_unchecked< ::x10::util::GrowableRail< ::x10::lang::Exception*>*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
        {
            ...
            //#line 36 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/ws/FinishFrame.x10"
            this->FMGL(redirect) = (::x10aux::class_cast_unchecked< ::x10::compiler::ws::FinishFrame*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
        }
    }
    void _constructor(x10_int id__49, ::x10::compiler::ws::FinishFrame* o);
    ...
    virtual void append(::x10::util::GrowableRail< ::x10::lang::Exception*>* s);
