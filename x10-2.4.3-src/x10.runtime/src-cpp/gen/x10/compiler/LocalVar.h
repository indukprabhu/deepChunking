...
//#line 17 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
template<class TPMGL(T)> void x10::compiler::LocalVar<TPMGL(T)>::_constructor(
                           TPMGL(T) local) {
    
    //#line 14 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
...
//#line 19 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
template<class TPMGL(T)> TPMGL(T) x10::compiler::LocalVar<TPMGL(T)>::__apply(
  ) {
    
    //#line 20 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
    return ::x10aux::class_cast<TPMGL(T)>(::x10aux::class_cast_unchecked< ::x10::lang::Any*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    
}

//#line 22 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
template<class TPMGL(T)> TPMGL(T) x10::compiler::LocalVar<TPMGL(T)>::get(
  ) {
    
    //#line 23 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
    return ::x10aux::class_cast<TPMGL(T)>(::x10aux::class_cast_unchecked< ::x10::lang::Any*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    
}

//#line 25 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
template<class TPMGL(T)> TPMGL(T) x10::compiler::LocalVar<TPMGL(T)>::__apply(
  TPMGL(T) local) {
    
    //#line 26 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/compiler/LocalVar.x10"
    return local;
