...
template<class TPMGL(T)> ::x10::lang::Iterator<TPMGL(T)>* x10::regionarray::Array__Anonymous__14235<TPMGL(T)>::iterator(
    ...
    ::x10::regionarray::Array__Anonymous__14235__Anonymous__14292<TPMGL(T)>* alloc__107623 =
    ...
    ::x10::regionarray::Array__Anonymous__14235<TPMGL(T)>* out__107622 =
      this;
    alloc__107623->FMGL(out__) = out__107622;
    
    //#line 415 "/home/induk/workspace/x10-2.4.3-src/x10.runtime/src-x10/x10/regionarray/Array.x10"
    return reinterpret_cast< ::x10::lang::Iterator<TPMGL(T)>*>(alloc__107623);
