...
public final class Runtime {
	...
	/*@author custom chunking extra variable
	*/
	public static CHUNK_DELTA = Configuration.deltaCustom();
    ...
    //@Suyash
        public static workerInstance:Workers = pool.getWorkers();
	public static IdleWorkers:Int = workerInstance.idleCount;
	
	//Method returning the count of NTHREADS
	public static def retNthreads():Int {
		return NTHREADS;
	}
	
	//Method returning the count of idle workers
	public static def retIdleWorkers():Int {
		return pool.workers.idleCount;
	}

	// Method returning the total count of workers
	public static def retTotalWorkers():Int {
    ...
    static final class Workers {
        ...
        public var spareCount:Int = 0n; // spare thread count
        public var idleCount:Int = 0n; // idle thread count
...
//                }
    ...
    static class Pool {
        ...
        public def getWorkers():Workers { return workers;	}
